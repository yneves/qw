...
module.exports = function (grunt) {
  ...
  var gruntConfig = {
    ...
    concat: {
      ...
      babel: {
        src: env.config.client.jsx,
        dest: path.resolve(env.getStaticRoot(), 'react.jsx')
      },

      client: {
        src: [].concat(env.config.client.js, path.resolve(env.getStaticRoot(), 'react.js')),
        dest: path.resolve(env.getStaticRoot(), 'index.js')
      },

      index: {
        src: env.config.client.html,
